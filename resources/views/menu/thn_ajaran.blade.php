...
<div class="container-fluid">
    <div class="fade-in">
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header"><h4>Data Tahun Ajaran</h4></div>
...
<!-- isi tabel -->
                <div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="example1_info">
                              ...
                              <button class="btn btn-sm btn-danger" type="reset"> Hapus</button></center></td></tr><tr role="row" class="even"><td class="sorting_1">2</td>
                              <td>2019/2020</td>
                              <td><a class="btn btn-success btn-xs" href="#"><span class="fa fa-check"></span></a></td>
                              <td><center>
                              <button class="btn btn-sm btn-success" type="submit"> Edit</button>
                              <button class="btn btn-sm btn-danger" type="reset"> Hapus</button></center></td></tr><tr role="row" class="odd"><td class="sorting_1">3</td>
                              <td>2018/2019</td>
                              <td><a class="btn btn-danger btn-xs" title="Aktifkan" href="?view=tahun&amp;act=onoff&amp;id=3&amp;a=Y"><span class="fa fa-close"></span></a></td>
                              <td><center>
                              <button class="btn btn-sm btn-success" type="submit"> Edit</button>
                              <button class="btn btn-sm btn-danger" type="reset"> Hapus</button></center></td></tr></tbody>
                  </table></div>
